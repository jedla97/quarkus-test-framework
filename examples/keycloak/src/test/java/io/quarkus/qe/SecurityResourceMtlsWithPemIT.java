...
@QuarkusScenario
public class SecurityResourceMtlsWithPemIT extends BaseSecurityResourceIT {

    @KeycloakContainer(runKeycloakInProdMode = true, mtlsEnabled = true, certificateFormat = Certificate.Format.PEM)
