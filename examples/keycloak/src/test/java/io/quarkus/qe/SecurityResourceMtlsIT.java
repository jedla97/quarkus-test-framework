...
@QuarkusScenario
public class SecurityResourceMtlsIT extends BaseSecurityResourceIT {

    @KeycloakContainer(runKeycloakInProdMode = true, mtlsEnabled = true, certificateFormat = Certificate.Format.JKS)
